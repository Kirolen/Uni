...
void ProcessInitialization(double *&pMatrix, double *&pVector,
                           ...
                           int &Size, int &RowNum, bool isTest = false)
{
...
void RunExperiment(double *&pMatrix, double *&pVector, double *&pResult,
                   double *&pProcRows, double *&pProcResult,
                   int Size, int &RowNum, int isTest)
{
    double Start, Finish, Duration;

    // Memory allocation and data initialization
    ProcessInitialization(pMatrix, pVector, pResult, pProcRows, pProcResult, Size, RowNum, isTest);
...
int main(int argc, char *argv[])
{
    ...
    if (isTest)
    {
        ...
        for (int t = 0; t < numTests; t++)
        {
            ...
            RunExperiment(pMatrix, pVector, pResult, pProcRows, pProcResult, Size, RowNum, isTest);
        }
    }
    else
        RunExperiment(pMatrix, pVector, pResult, pProcRows, pProcResult, Size, RowNum, isTest);
